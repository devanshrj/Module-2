...
def central_difference(f, *vals, arg=0, epsilon=1e-6):
    ...
    first_term = list(vals)
    first_term[arg] = first_term[arg] + epsilon
    second_term = list(vals)
    second_term[arg] = second_term[arg] - epsilon

    numerator = f(*first_term) - f(*second_term)
